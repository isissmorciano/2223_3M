...
#Inserimento input
nominativo = input("Inserire il proprio nome e cognome: ")
voto1 = int(input("Inserire un voto da 1 a 10: "))
voto2 = int(input("Inserire un voto da 1 a 10: "))
voto3 = int(input("Inserire un voto da 1 a 10: "))
voto4 = int(input("Inserire un voto da 1 a 10: "))
